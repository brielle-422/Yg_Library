...
public class ImageCycleView extends LinearLayout {
     ...
     */
    public void setImageResources(ArrayList<BannerItem> infoList, ImageCycleViewListener imageCycleViewListener) {
        // 清除所有子视图
...
//		else{
//		mBannerPager.setScrollble(false);
//		}
    ...
    private final class GuidePageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            index -= 1;
            mImageViews[index].setBackgroundResource(R.drawable.page_indicator_focused);
    ...
    private class ImageCycleAdapter extends PagerAdapter {
         ...
         * 图片资源列表
         */
        private ArrayList<BannerItem> mAdList = new ArrayList<BannerItem>();
        ...
        public ImageCycleAdapter(Context context, ArrayList<BannerItem> adList, ImageCycleViewListener imageCycleViewListener) {
            mContext = context;
            mAdList = adList;
